...
BEGIN
    ...
    SET @new_salary = CASE
        WHEN @avg_salary > 50000 THEN @avg_salary * 0.9  -- 10% reduction if avg salary is above 50,000
        WHEN @avg_salary < 30000 THEN @avg_salary        -- Keep the same salary if it's below 30,000
        ELSE @avg_salary * 0.8  -- Apply 20% reduction if avg salary is between 30,000 and 50,000
    END;
